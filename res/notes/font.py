...
print("; Replay Mono pixel font")
print("; (c) 2025 by 4am")
print("; license:Open Font License 1.1, see OFL.txt")
print("; derived from Mono Number 5, (c) 2023 by 4am")
print("; https://github.com/a2-4am/fonts/tree/main/Mono%20Number%205")
print("; Replay Mono adds distinct uppercase letters and several glyphs")
