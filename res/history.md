...
- Fix crash in Fat City on some machines (closes [844](https://github.com/a2-4am/4cade/issues/844))
...
- Fix colors on Apple //c in Batman, Death Sword, Impossible Mission II, Puyo Puyo, and Victory Road (thanks Frank M.)
...
- Fix game help for Kaboom!
- Fix joystick detection on Apple //c (closes [851](https://github.com/a2-4am/4cade/issues/851), thanks Frank M.)
- Fix joystick handling in Aquatron
- Fix artwork handling while loading Crossbow
